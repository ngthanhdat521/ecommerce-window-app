  ...
  return (
    <section className="w-full min-h-full flex items-center bg-gray-50 dark:bg-gray-900">
      <div className="grid grid-cols-12 w-full">
        <div className="w-full 2xl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12">
          <div className="flex justify-center p-5">
            <img className="md:w-[600px] sm:w-[300px]" src={RemoteSrc} alt="My Happy SVG" />
          </div>
        </div>
        <div className="2xl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-12">
          <div className="flex md:justify-start sm:justify-center p-5">
