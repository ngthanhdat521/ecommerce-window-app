import ShoppingCart1 from '../../assets/shopping-cart-01.jpg'
import ShoppingCart2 from '../../assets/shopping-cart-02.jpg'
import ShoppingCart3 from '../../assets/shopping-cart-03.jpg'

export const MyCartPage = () => {
  return (
    <div className="w-full h-full mt-20" aria-labelledby="slide-over-title">
      <div className="grid grid-cols-12 gap-x-32 sm:gap-x-0 sm:gap-y-10 bg-white lg:gap-10">
        <div className="2xl:col-span-8 xl:col-span-8 lg:col-span-7 md:col-span-12 sm:col-span-12">
        ...
        <div className="2xl:col-span-4 xl:col-span-4 lg:col-span-5 md:col-span-12 sm:col-span-12 flex justify-end bg-gray-100 rounded-md p-7">
          <div className="w-full">
            ...
            <div className="divide-y divide-gray-200">
              ...
              <div className="flex justify-between py-3">
                <p className="text-sm font-normal text-gray-500">Shipping estimate</p>
